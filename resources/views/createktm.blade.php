                ...
                <form action="/pendaftaran" method="post" enctype="multipart/form-data">
                    ...
                    <div class="inline">
                        <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror" type="radio"
                            ...
                            {{ 'Laki-Laki' == old('jenis_kelamin') ? 'checked' : '' }}>
                    ...
                    <div class="inline ml-5">
                        <input class="form-check-input @error('jenis_kelamin') is-invalid @enderror" type="radio"
                            ...
                            {{ 'Perempuan' == old('jenis_kelamin') ? 'checked' : '' }}>
                    ...
                    <select
                        ...
                        @for ($h = 1; $h <= 31; $h++)
                            <option value="{{ $h }}" {{ $h == old('tanggal_lahir') ? 'selected' : '' }}>
                                {{ $h }}
                            </option>
                        @endfor
                    </select>
                    ...
                    <select
                        ...
                        @for ($b = 0; $b < 12; $b++)
                            ...
                            <option value="{{ $nama_bulan[$b] }}"
                                {{ $nama_bulan[$b] == old('bulan_lahir') ? 'selected' : '' }}>
                                {{ $nama_bulan[$b] }}</option>
                        @endfor
                    </select>
                    @error('bulan_lahir')
                    ...
                    <select
                        ...
                        @for ($t = 2022; $t >= 1990; $t--)
                            <option value="{{ $t }}" {{ $t == old('tahun_lahir') ? 'selected' : '' }}>
                                {{ $t }}
                            </option>
                        @endfor
                    </select>
